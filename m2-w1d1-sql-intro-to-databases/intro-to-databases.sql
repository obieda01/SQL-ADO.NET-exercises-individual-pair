...
SELECT name, (GNP/population)as percapita FROM country WHERE continent='Europe'

-- 22. The number of years since independence for all countries that have a year of independence (192 rows)

SELECT name,(2017-indepyear) FROM country WHERE indepyear IS NOT NULL OR indepyear !=0 
