...
namespace ProjectDB
{
    public class ProjectCLI
    {
        ...
        const string DatabaseConnection = @"Data Source=DESKTOP-381115Q\SQLEXPRESS;Initial Catalog=ProjectOrganizer;Persist Security Info=True;User ID=student;Password=student";
